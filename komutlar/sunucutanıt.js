...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .setDescription('Sunucu [Burada](https://discord.gg/KUk89PR) Tanıtıldı! \n\n 12 Saat Sonra Sunucunuzu Tekrardan Tanıtabilirsiniz. \n\n Sunucunu Tanıtabilmek İçin Beni [Ekle!](https://discord.com/oauth2/authorize?client_id=731219163317534740&scope=bot&permissions=8)')
  .setColor('GREEN')
 message.channel.send(embed);
    message.channel.createInvite({maxAge: 0}).then((invite) => {
      ...
      .setThumbnail(message.guild.iconURL)
       client.channels.cache.get('739261978002063400').send(embed)
            });
  ...
  {
  message.channel.send({embed: {
      description: '**BAŞARISIZ TANITIM** \n\nBu komut zaten kullanılmış!\n\nSunucunu 12 saate 1 defa tanıtabilirsin! \n\n[<@535681249768112128> | Discord.js | Kod Paylaşım](https://discord.gg/KUk89PR) \n[Destek İçin Ekle](https://discord.com/oauth2/authorize?client_id=731219163317534740&scope=bot&permissions=8)'
            }});
  }
};
exports.conf = {
